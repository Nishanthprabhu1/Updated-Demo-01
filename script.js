/* script.js - Jewels-Ai Atelier: v3.1 (Enterprise + Gesture Fix) */
...
let physics = { 
    earringAngle: 0, 
    earringVelocity: 0,
    swayOffset: 0,    // Lateral swing for Jhumkas
    lastHeadX: 0      // To track head speed
};
...
hands.onResults((results) => {
  ...
  // 1. GESTURE TRACKING (RUNS FOR ALL MODES)
